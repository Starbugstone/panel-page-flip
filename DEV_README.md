...
| [sharing-management.md](docs/sharing-management.md) | Server-paged owner share table, filters, selection, and bulk actions |
...
#### ✅ Comic Sharing
- **Sharing Page**: `Sharing.jsx` at `/sharing` — where shares are both started and managed, with "Shared with me" cards for invitations/access/tombstones and a server-backed **Shared by me** table. The owner table searches and filters the full history, sorts by each data column, selects a page or shift-click range, bulk-revokes live grants, and bulk-deletes finished records. See [sharing-management.md](docs/sharing-management.md)
