    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE content_report (
                ...
                INDEX IDX_CONTENT_REPORT_REVIEWER (reviewed_by_admin_id),
                INDEX IDX_CONTENT_REPORT_USER (linked_user_id),
                INDEX IDX_CONTENT_REPORT_COMIC (linked_comic_id),
                INDEX IDX_CONTENT_REPORT_SHARE (linked_share_id),
