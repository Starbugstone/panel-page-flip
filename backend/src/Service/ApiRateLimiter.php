...
final class ApiRateLimiter
{
    public function __construct(
        ...
        private readonly RateLimiterFactory $oauthStartLimiter,
        private readonly RateLimiterFactory $oauthCallbackLimiter,
        private readonly RateLimiterFactory $oauthRegistrationLimiter,
    ...
    public function limit(Request $request, string $limiterName, ?string $key = null): ?JsonResponse
    {
        $factory = match ($limiterName) {
            ...
            'oauth_start' => $this->oauthStartLimiter,
            'oauth_callback' => $this->oauthCallbackLimiter,
            'oauth_registration' => $this->oauthRegistrationLimiter,
